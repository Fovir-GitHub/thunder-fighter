...
/**
 * UiDialog class for displaying various dialogs in the Thunder Fighter game. This class will be
 * used in UiScoreStorage, UiMenu and etc. to show dialogs. In this class, we define methods to show
 * information dialogs, about dialog, and game rule dialog. Therefore, we can reuse this class to
 * show different types of dialogs by using the methods showInfoDialog, showAboutDialog, and
 * showRuleDialog.
 */
